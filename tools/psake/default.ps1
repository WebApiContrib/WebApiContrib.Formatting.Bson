...
Task NuGetBuild {
	& $nuget_exe pack "$base_dir/src/WebApiContrib.Formatting.Bson/WebApiContrib.Formatting.Bson.csproj" -Build -OutputDirectory $build_artifacts_dir -Verbose -Properties Configuration=Release
}
